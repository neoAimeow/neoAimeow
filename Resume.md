...
| ---- | ---- | -------- | ----------- | ---------------------- | -------- |
| 男   | 34   | Siy-Wuzy | 18610003572 | a18814888787@gmail.com | 不限     |
...
擅长前端、iOS 开发，也有后端开发经历，有过**四年前端，五年 iOS，两年 JAVA，两年全栈经历**。对于音视频技术、直播技术、体感技术、游戏开发等多方面都有涉猎。执行能力与推动业务能力较强，有多个 app、小程序、全栈项目独立开发的经历，开发经历比较丰富。

## 工作经历

#### creatify.ai 远程工作-前端负责人 (2023.4~至今)

自由职业的这段时间里加入了 creatify 做前端开发，参与开发各类以生成视频为主的 ai 工具以及视频编辑器（类似剪映）并且重构，在这个团队里，带着三位初级前端一起开发 creatify，承担了大部分核心需求的迭代与开发。在这个阶段，creatify 成功获得 ai grant 的 pre a 轮融资，并获得业内众多机构认可。
